...
// Lista de livros de Allansia e suas localizações
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 font-sans">
      ...
      <div className="flex-1 flex flex-col gap-3">
        ...
        {/* Container do Mapa */}
        <div
          className={`relative w-full aspect-[5/3] overflow-hidden border-2 ${
            isPapyrus
        ...
        >
          ...
          {imageError ? (
            <div className="absolute inset-0 select-none">
              ...
              <svg viewBox="0 0 1000 600" className="w-full h-full opacity-80" fill="none">
                ...
                {/* Ilhas Menores Ocidentais (Ilha de Sangue) */}
                <path
                ...
                {/* Cadeias de Montanhas (Pequenos Triângulos) */}
                <g className="opacity-15" stroke="currentColor" strokeWidth="1.5">
                  {/* Montes Gelados no Norte */}
                ...
                {/* Floresta de Darkwood (Estilização com círculos verdes) */}
                ...
                {/* Rótulos dos Mapas em Latim/Fantasia */}
              ...
              {/* Informação sobre como colocar o arquivo real */}
          ...
          {ALLANSIA_LOCATIONS.map((loc) => {
            ...
            return (
              <button
                ...
                className="absolute group z-10 -translate-x-1/2 -translate-y-1/2 cursor-pointer transition-transform hover:scale-125 focus:outline-none"
              ...
              >
                {isActive ? (
                  ...
                  /* Pin Inativo (Apenas outros pontos de interesse do atlas de Titan) */
                  <div className="relative flex items-center justify-center">
                    <div
