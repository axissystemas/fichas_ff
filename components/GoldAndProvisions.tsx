    ...
    <div className="grid grid-cols-2 gap-4 mt-6">
      <div className={`${isPapyrus ? 'bg-[#EAD8B8] border-[#5C4033] text-[#5C4033]' : 'bg-[#1a202c] border-[#4a5568] text-[#cbd5e0]'} border p-4 text-center transition-colors`}>
        ...
        <div className="flex gap-2 justify-center flex-wrap">
          <button onClick={() => updateGold(10)} className={`${isPapyrus ? 'bg-[#2C1E14] text-[#EAD8B8]' : 'bg-[#2d3748] text-white hover:bg-slate-600'} px-2 py-1 text-xs transition-colors rounded-sm`}>+10</button>
          <button onClick={() => updateGold(1)} className={`${isPapyrus ? 'bg-[#2C1E14] text-[#EAD8B8]' : 'bg-[#2d3748] text-white hover:bg-slate-600'} px-2 py-1 text-xs transition-colors rounded-sm`}>+1</button>
          <button onClick={() => updateGold(-1)} className={`${isPapyrus ? 'bg-[#2C1E14] text-[#EAD8B8]' : 'bg-[#2d3748] text-white hover:bg-slate-600'} px-2 py-1 text-xs transition-colors rounded-sm`}>-1</button>
          <button onClick={() => updateGold(-10)} className={`${isPapyrus ? 'bg-[#2C1E14] text-[#EAD8B8]' : 'bg-[#2d3748] text-white hover:bg-slate-600'} px-2 py-1 text-xs transition-colors rounded-sm`}>-10</button>
        </div>
      </div>
      <div className={`${isPapyrus ? 'bg-[#EAD8B8] border-[#5C4033] text-[#5C4033]' : 'bg-[#1a202c] border-[#4a5568] text-[#cbd5e0]'} border p-4 text-center transition-colors`}>
        ...
        <div className="flex gap-2 justify-center">
          ...
          <button onClick={() => updateProvisions(1)} className={`${isPapyrus ? 'bg-[#2C1E14] text-[#EAD8B8]' : 'bg-[#2d3748] text-white hover:bg-slate-600'} px-3 py-1 text-xs transition-colors rounded-sm`}>+1</button>
        </div>
      </div>
    </div>
  );
