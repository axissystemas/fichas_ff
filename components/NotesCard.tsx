...
export const NotesCard = () => {
  ...
  return (
    <div className={`${cardClasses} border-2 p-4 shadow-[-5px_5px_0px_rgba(0,0,0,0.3)] transition-colors flex flex-col flex-grow`}>
      ...
      <textarea
        ...
        className={`w-full h-full p-2 bg-transparent border ${theme === 'papyrus' ? 'border-[#4A3728]' : 'border-[#cbd5e0]'} resize-none`}
